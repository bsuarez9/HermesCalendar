"""
WSGI entry point para Cloudera AI Workbench Applications
Cloudera detecta y sirve automáticamente el objeto 'application'
"""
import os
...
if os.path.exists(project_dir):
    ...
    print(f"⚠️ Usando directorio actual: {os.getcwd()}")
...
print(f"✅ WSGI application lista")
print(f"🌐 Cloudera servirá automáticamente en el puerto asignado")
